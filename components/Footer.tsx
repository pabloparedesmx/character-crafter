...
const REMIX_IDEAS = [
    "to generate pixel art sprites.",
    "to create different outfits for your character.",
    "to design a side-scroller game character.",
    "to generate sticker sheets of your pet.",
    "to place your character in different scenes.",
    "to animate your character's expressions.",
];
